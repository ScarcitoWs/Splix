...
do
    ...
    function library:New(info)
        ...
        theme.accent = accent
        --
        local window = {pages = {}, isVisible = false, uibind = Enum.KeyCode.LeftAlt, currentPage = nil, fading = false, dragging = false, drag = Vector2.new(0,0), currentContent = {frame = nil, dropdown = nil, multibox = nil, colorpicker = nil, keybind = nil}}
        --
        ...
        function window:CloseContent()
            if window.currentContent.dropdown and window.currentContent.dropdown.open then
                ...
                utility:LoadImage(dropdown.dropdown_image, "arrow_down", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/tVqy0nL.png")
                --
            ...
            elseif window.currentContent.multibox and window.currentContent.multibox.open then
                ...
                utility:LoadImage(multibox.multibox_image, "arrow_down", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/tVqy0nL.png")
                --
        ...
        function window:Watermark(info)
            ...
            --
            local info = info or {}
            local watermark_name = info.name or info.Name or info.title or info.Title or string.format("[Scani-O5]", 1, 100, 200)
            --
            ...
            local watermark_title = utility:Create("TextLabel", {Vector2.new(2 + 6,4), watermark_outline}, {
                Text = string.format("[Scani-O5]", 35, 2),
                Size = theme.textsize,
                Font = theme.font,
                Color = theme.textcolor,
                OutlineColor = theme.textborder,
            ...
            --
            watermark_title.Text = string.format("[Scani-O5]", 1, tostring(library.shared.ping), library.shared.fps)
            window.watermark:UpdateSize()
            --
            spawn(function()
                while wait(0.1) do
                    pcall(function()    
		    if getgenv().CTarget and getgenv().CTarget.Character and getgenv().CTarget.Character:FindFirstChild("Humanoid") then 
                    watermark_title.Text = "[Scani-O5] Target: "..getgenv().CTarget.Name.." ("..getgenv().CTarget.DisplayName..") "
		    else 
                    watermark_title.Text = "[Scani-O5]"		    
		    end 
                    window.watermark:UpdateSize()
                    end)
                end
        ...
        --
        utility:Connection(uis.InputBegan,function(Input, gm)
	if not gm then
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            --
            if transp then
                utility:LoadImage(colorpicker__transparency, "cptransp", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/IIPee2A.png")
            end
            utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
            --
                    ...
                    elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                        if not colorpicker.open then
                            ...
                            if transp then
                                ...
                                --
                                utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/ncssKbH.png")
                            end
                            --
                            utility:LoadImage(colorpicker_open_picker_image, "valsat", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/wpDRqVH.png")
                            utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor", "https://raw.githubusercontent.com/ScarcitoWs/ScarcinBro/main/Images-cursor.png")
                            utility:LoadImage(colorpicker_open_huepicker_image, "hue", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/iEOsHFv.png")
                            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
            --
    ...
    function sections:Slider(info)
        ...
        local slider_inline = utility:Create("Frame", {Vector2.new(1,1), slider_outline}, {
            Size = utility:Size(1, -2, 1.05, -2, slider_outline),
        ...
        local slider_frame = utility:Create("Frame", {Vector2.new(1,1), slider_inline}, {
            Size = utility:Size(1, -2, 1.05, -2, slider_inline),
        ...
        local slider_slide = utility:Create("Frame", {Vector2.new(1,1), slider_inline}, {
            Size = utility:Size(0, (slider_frame.Size.X / (slider.max - slider.min) * (slider.current - slider.min)), 1.05, -2, slider_inline),
            Position = utility:Position(0, 1, 0, 1, slider_inline),
            Color = theme.accent,
            Visible = page.open
        }, section.visibleContent)
        ...
        local slider__gradient = utility:Create("Image", {Vector2.new(0,0), slider_frame}, {
            Size = utility:Size(1, 0, 1.05, 0, slider_frame),
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Dropdown(info)
        ...
        --
        utility:LoadImage(dropdown_image, "arrow_down", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/tVqy0nL.png")
        utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
        --
            ...
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + 15 +  20}) and not window:IsOverContent() then
                    if not dropdown.open then
                        window:CloseContent()
                        dropdown.open = not dropdown.open
                        utility:LoadImage(dropdown_image, "arrow_up", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/SL9cbQp.png")
                        --
    ...
    function sections:Multibox(info)
        ...
        --
        utility:LoadImage(multibox_image, "arrow_down", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/tVqy0nL.png")
        utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
        --
            ...
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + 15 +  20}) and not window:IsOverContent() then
                    if not multibox.open then
                        window:CloseContent()
                        multibox.open = not multibox.open
                        utility:LoadImage(multibox_image, "arrow_up", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/SL9cbQp.png")
                        --
    ...
    function sections:ConfigBox(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", "https://raw.githubusercontent.com/ScarcitoWs/PNGS/main/5hmlrjX.png")
        --
